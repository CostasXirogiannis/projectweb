...
<head>
  ...
  <script src="ttlavg.js" onload="my_function('all_content_types', 'all_providers')"></script>
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script> <!--Google charts histogram-->
...
<body>
    ...
    <div id="chart_div" style="width: 70%; height: 60%; margin: 0; padding: 10px; display: block; margin-left: auto; margin-right: auto;"></div> <!--Google charts histogram-->
